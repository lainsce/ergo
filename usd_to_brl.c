...
/* begin embedded module: net */
static YisVal yis_net__hex_digit(YisVal);
static YisVal yis_net__is_alpha_num(YisVal);
static YisVal yis_net__is_unreserved(YisVal);
static YisVal yis_net__shell_quote(YisVal);
static YisVal yis_net__contains(YisVal, YisVal);
static YisVal yis_net__last_index_of(YisVal, YisVal);
static YisVal yis_net__parse_int(YisVal);
static YisVal yis_net__pair_key(YisVal);
static YisVal yis_net__pair_val(YisVal);
static YisVal yis_net_encode_component(YisVal);
static YisVal yis_net_build_query(YisVal);
static YisVal yis_net_with_query(YisVal, YisVal);
static YisVal yis_net__parse_status_payload(YisVal);
static YisVal yis_net_request(YisVal, YisVal, YisVal, YisVal, YisVal, YisVal, YisVal);
static YisVal yis_net_get(YisVal, YisVal, YisVal, YisVal);
static YisVal yis_net_post(YisVal, YisVal, YisVal, YisVal, YisVal);
static YisVal yis_net_post_json(YisVal, YisVal, YisVal, YisVal, YisVal);
static YisVal __fnwrap_net__hex_digit(void*,int,YisVal*);
static YisVal __fnwrap_net__is_alpha_num(void*,int,YisVal*);
static YisVal __fnwrap_net__is_unreserved(void*,int,YisVal*);
static YisVal __fnwrap_net__shell_quote(void*,int,YisVal*);
static YisVal __fnwrap_net__contains(void*,int,YisVal*);
static YisVal __fnwrap_net__last_index_of(void*,int,YisVal*);
static YisVal __fnwrap_net__parse_int(void*,int,YisVal*);
static YisVal __fnwrap_net__pair_key(void*,int,YisVal*);
static YisVal __fnwrap_net__pair_val(void*,int,YisVal*);
static YisVal __fnwrap_net_encode_component(void*,int,YisVal*);
static YisVal __fnwrap_net_build_query(void*,int,YisVal*);
static YisVal __fnwrap_net_with_query(void*,int,YisVal*);
static YisVal __fnwrap_net__parse_status_payload(void*,int,YisVal*);
static YisVal __fnwrap_net_request(void*,int,YisVal*);
static YisVal __fnwrap_net_get(void*,int,YisVal*);
static YisVal __fnwrap_net_post(void*,int,YisVal*);
static YisVal __fnwrap_net_post_json(void*,int,YisVal*);

// cask net
// bring stdr
static YisVal yis_net__hex_digit(YisVal v_n) {
#line 9 "src/stdlib/net.yi"
  YisVal v_digits = YV_STR(stdr_str_lit("0123456789ABCDEF")); yis_retain_val(v_digits);
#line 10 "src/stdlib/net.yi"
  return stdr_slice(v_digits, yis_as_int(v_n), yis_as_int(yis_add(v_n, YV_INT(1))));
}

static YisVal yis_net__is_alpha_num(YisVal v_code) {
#line 14 "src/stdlib/net.yi"
  if (yis_as_bool(YV_BOOL(yis_as_bool(yis_ge(v_code, YV_INT(48))) && yis_as_bool(yis_le(v_code, YV_INT(57)))))) {
    return YV_BOOL(true);
  }
#line 15 "src/stdlib/net.yi"
  if (yis_as_bool(YV_BOOL(yis_as_bool(yis_ge(v_code, YV_INT(65))) && yis_as_bool(yis_le(v_code, YV_INT(90)))))) {
    return YV_BOOL(true);
  }
#line 16 "src/stdlib/net.yi"
  if (yis_as_bool(YV_BOOL(yis_as_bool(yis_ge(v_code, YV_INT(97))) && yis_as_bool(yis_le(v_code, YV_INT(122)))))) {
    return YV_BOOL(true);
  }
#line 17 "src/stdlib/net.yi"
  return YV_BOOL(false);
}

static YisVal yis_net__is_unreserved(YisVal v_code) {
#line 21 "src/stdlib/net.yi"
  if (yis_as_bool(yis_net__is_alpha_num(v_code))) {
    return YV_BOOL(true);
  }
#line 22 "src/stdlib/net.yi"
  if (yis_as_bool(YV_BOOL(yis_as_bool(YV_BOOL(yis_as_bool(YV_BOOL(yis_as_bool(yis_eq(v_code, YV_INT(45))) || yis_as_bool(yis_eq(v_code, YV_INT(46))))) || yis_as_bool(yis_eq(v_code, YV_INT(95))))) || yis_as_bool(yis_eq(v_code, YV_INT(126)))))) {
    return YV_BOOL(true);
  }
#line 23 "src/stdlib/net.yi"
  return YV_BOOL(false);
}

static YisVal yis_net__shell_quote(YisVal v_text) {
#line 27 "src/stdlib/net.yi"
  YisVal v_parts = yis_arr_lit(0); yis_retain_val(v_parts);
#line 28 "src/stdlib/net.yi"
  (void)(stdr_push(v_parts, YV_STR(stdr_str_lit("'"))));
#line 29 "src/stdlib/net.yi"
  YisVal v_chunk_start = YV_INT(0); yis_retain_val(v_chunk_start);
#line 30 "src/stdlib/net.yi"
  YisVal v_n = YV_INT(stdr_len(v_text)); yis_retain_val(v_n);
#line 31 "src/stdlib/net.yi"
  YisVal v_i = YV_INT(0); yis_retain_val(v_i);
#line 32 "src/stdlib/net.yi"
  for (; yis_as_bool(yis_lt(v_i, v_n)); (void)((yis_move_into(&v_i, yis_add(v_i, YV_INT(1))), v_i))) {
#line 33 "src/stdlib/net.yi"
    YisVal v_ch = stdr_slice(v_text, yis_as_int(v_i), yis_as_int(yis_add(v_i, YV_INT(1)))); yis_retain_val(v_ch);
#line 34 "src/stdlib/net.yi"
    if (yis_as_bool(yis_eq(v_ch, YV_STR(stdr_str_lit("'"))))) {
#line 35 "src/stdlib/net.yi"
      if (yis_as_bool(yis_lt(v_chunk_start, v_i))) {
        (void)(stdr_push(v_parts, stdr_slice(v_text, yis_as_int(v_chunk_start), yis_as_int(v_i))));
      }
#line 36 "src/stdlib/net.yi"
      (void)(stdr_push(v_parts, YV_STR(stdr_str_lit("'\"'\"'"))));
#line 37 "src/stdlib/net.yi"
      (void)((yis_move_into(&v_chunk_start, yis_add(v_i, YV_INT(1))), v_chunk_start));
    }
  }
#line 38 "src/stdlib/net.yi"
  if (yis_as_bool(yis_lt(v_chunk_start, v_n))) {
    (void)(stdr_push(v_parts, stdr_slice(v_text, yis_as_int(v_chunk_start), yis_as_int(v_n))));
  }
#line 39 "src/stdlib/net.yi"
  (void)(stdr_push(v_parts, YV_STR(stdr_str_lit("'"))));
#line 40 "src/stdlib/net.yi"
  return yis_stdr_join(v_parts);
}

static YisVal yis_net__contains(YisVal v_text, YisVal v_needle) {
#line 44 "src/stdlib/net.yi"
  YisVal v_tn = YV_INT(stdr_len(v_text)); yis_retain_val(v_tn);
#line 45 "src/stdlib/net.yi"
  YisVal v_nn = YV_INT(stdr_len(v_needle)); yis_retain_val(v_nn);
#line 46 "src/stdlib/net.yi"
  if (yis_as_bool(yis_eq(v_nn, YV_INT(0)))) {
    return YV_BOOL(true);
  }
#line 47 "src/stdlib/net.yi"
  if (yis_as_bool(yis_gt(v_nn, v_tn))) {
    return YV_BOOL(false);
  }
#line 48 "src/stdlib/net.yi"
  YisVal v_i = YV_INT(0); yis_retain_val(v_i);
#line 49 "src/stdlib/net.yi"
  YisVal v_end = yis_sub(v_tn, v_nn); yis_retain_val(v_end);
#line 50 "src/stdlib/net.yi"
  for (; yis_as_bool(yis_le(v_i, v_end)); (void)((yis_move_into(&v_i, yis_add(v_i, YV_INT(1))), v_i))) {
#line 51 "src/stdlib/net.yi"
    if (yis_as_bool(yis_eq(stdr_slice(v_text, yis_as_int(v_i), yis_as_int(yis_add(v_i, v_nn))), v_needle))) {
      return YV_BOOL(true);
    }
  }
#line 52 "src/stdlib/net.yi"
  return YV_BOOL(false);
}

static YisVal yis_net__last_index_of(YisVal v_text, YisVal v_needle) {
#line 56 "src/stdlib/net.yi"
  YisVal v_tn = YV_INT(stdr_len(v_text)); yis_retain_val(v_tn);
#line 57 "src/stdlib/net.yi"
  YisVal v_nn = YV_INT(stdr_len(v_needle)); yis_retain_val(v_nn);
#line 58 "src/stdlib/net.yi"
  if (yis_as_bool(YV_BOOL(yis_as_bool(yis_eq(v_nn, YV_INT(0))) || yis_as_bool(yis_gt(v_nn, v_tn))))) {
    return yis_neg(YV_INT(1));
  }
#line 59 "src/stdlib/net.yi"
  YisVal v_pos = yis_neg(YV_INT(1)); yis_retain_val(v_pos);
#line 60 "src/stdlib/net.yi"
  YisVal v_i = YV_INT(0); yis_retain_val(v_i);
#line 61 "src/stdlib/net.yi"
  YisVal v_end = yis_sub(v_tn, v_nn); yis_retain_val(v_end);
#line 62 "src/stdlib/net.yi"
  for (; yis_as_bool(yis_le(v_i, v_end)); (void)((yis_move_into(&v_i, yis_add(v_i, YV_INT(1))), v_i))) {
#line 63 "src/stdlib/net.yi"
    if (yis_as_bool(yis_eq(stdr_slice(v_text, yis_as_int(v_i), yis_as_int(yis_add(v_i, v_nn))), v_needle))) {
#line 64 "src/stdlib/net.yi"
      (void)((yis_move_into(&v_pos, v_i), v_pos));
    }
  }
#line 65 "src/stdlib/net.yi"
  return v_pos;
}

static YisVal yis_net__parse_int(YisVal v_text) {
#line 69 "src/stdlib/net.yi"
  YisVal v_v = YV_INT(0); yis_retain_val(v_v);
#line 70 "src/stdlib/net.yi"
  YisVal v_i = YV_INT(0); yis_retain_val(v_i);
#line 71 "src/stdlib/net.yi"
  YisVal v_n = YV_INT(stdr_len(v_text)); yis_retain_val(v_n);
#line 72 "src/stdlib/net.yi"
  for (; yis_as_bool(yis_lt(v_i, v_n)); (void)((yis_move_into(&v_i, yis_add(v_i, YV_INT(1))), v_i))) {
#line 73 "src/stdlib/net.yi"
    YisVal v_ch = stdr_slice(v_text, yis_as_int(v_i), yis_as_int(yis_add(v_i, YV_INT(1)))); yis_retain_val(v_ch);
#line 74 "src/stdlib/net.yi"
    YisVal v_code = YV_INT(stdr_char_code(v_ch)); yis_retain_val(v_code);
#line 75 "src/stdlib/net.yi"
    if (yis_as_bool(YV_BOOL(yis_as_bool(yis_lt(v_code, YV_INT(48))) || yis_as_bool(yis_gt(v_code, YV_INT(57)))))) {
      break;
    }
#line 76 "src/stdlib/net.yi"
    (void)((yis_move_into(&v_v, yis_add(yis_mul(v_v, YV_INT(10)), yis_sub(v_code, YV_INT(48)))), v_v));
  }
#line 77 "src/stdlib/net.yi"
  return v_v;
}

static YisVal yis_net__pair_key(YisVal v_pair) {
#line 81 "src/stdlib/net.yi"
  if (yis_as_bool(yis_ge(YV_INT(stdr_len(v_pair)), YV_INT(1)))) {
    return YV_STR(stdr_to_string(yis_index(v_pair, YV_INT(0))));
  }
#line 82 "src/stdlib/net.yi"
  return YV_STR(stdr_str_lit(""));
}

static YisVal yis_net__pair_val(YisVal v_pair) {
#line 86 "src/stdlib/net.yi"
  if (yis_as_bool(yis_ge(YV_INT(stdr_len(v_pair)), YV_INT(2)))) {
    return YV_STR(stdr_to_string(yis_index(v_pair, YV_INT(1))));
  }
#line 87 "src/stdlib/net.yi"
  return YV_STR(stdr_str_lit(""));
}

static YisVal yis_net_encode_component(YisVal v_text) {
#line 91 "src/stdlib/net.yi"
  YisVal v_parts = yis_arr_lit(0); yis_retain_val(v_parts);
#line 92 "src/stdlib/net.yi"
  YisVal v_chunk_start = YV_INT(0); yis_retain_val(v_chunk_start);
#line 93 "src/stdlib/net.yi"
  YisVal v_n = YV_INT(stdr_len(v_text)); yis_retain_val(v_n);
#line 94 "src/stdlib/net.yi"
  YisVal v_i = YV_INT(0); yis_retain_val(v_i);
#line 95 "src/stdlib/net.yi"
  for (; yis_as_bool(yis_lt(v_i, v_n)); (void)((yis_move_into(&v_i, yis_add(v_i, YV_INT(1))), v_i))) {
#line 96 "src/stdlib/net.yi"
    YisVal v_code = YV_INT(stdr_char_code(stdr_slice(v_text, yis_as_int(v_i), yis_as_int(yis_add(v_i, YV_INT(1)))))); yis_retain_val(v_code);
#line 97 "src/stdlib/net.yi"
    if (yis_as_bool(YV_BOOL(!yis_as_bool(yis_net__is_unreserved(v_code))))) {
#line 98 "src/stdlib/net.yi"
      if (yis_as_bool(yis_lt(v_chunk_start, v_i))) {
        (void)(stdr_push(v_parts, stdr_slice(v_text, yis_as_int(v_chunk_start), yis_as_int(v_i))));
      }
#line 99 "src/stdlib/net.yi"
      YisVal v_hi = yis_div(v_code, YV_INT(16)); yis_retain_val(v_hi);
#line 100 "src/stdlib/net.yi"
      YisVal v_lo = yis_sub(v_code, yis_mul(v_hi, YV_INT(16))); yis_retain_val(v_lo);
#line 101 "src/stdlib/net.yi"
      (void)(stdr_push(v_parts, YV_STR(stdr_str_lit("%"))));
#line 102 "src/stdlib/net.yi"
      (void)(stdr_push(v_parts, yis_net__hex_digit(v_hi)));
#line 103 "src/stdlib/net.yi"
      (void)(stdr_push(v_parts, yis_net__hex_digit(v_lo)));
#line 104 "src/stdlib/net.yi"
      (void)((yis_move_into(&v_chunk_start, yis_add(v_i, YV_INT(1))), v_chunk_start));
    }
  }
#line 105 "src/stdlib/net.yi"
  if (yis_as_bool(yis_lt(v_chunk_start, v_n))) {
    (void)(stdr_push(v_parts, stdr_slice(v_text, yis_as_int(v_chunk_start), yis_as_int(v_n))));
  }
#line 106 "src/stdlib/net.yi"
  return yis_stdr_join(v_parts);
}

static YisVal yis_net_build_query(YisVal v_params) {
#line 110 "src/stdlib/net.yi"
  YisVal v_parts = yis_arr_lit(0); yis_retain_val(v_parts);
#line 111 "src/stdlib/net.yi"
  YisVal v_i = YV_INT(0); yis_retain_val(v_i);
#line 112 "src/stdlib/net.yi"
  YisVal v_n = YV_INT(stdr_len(v_params)); yis_retain_val(v_n);
#line 113 "src/stdlib/net.yi"
  for (; yis_as_bool(yis_lt(v_i, v_n)); (void)((yis_move_into(&v_i, yis_add(v_i, YV_INT(1))), v_i))) {
#line 114 "src/stdlib/net.yi"
    YisVal v_pair = yis_index(v_params, v_i); yis_retain_val(v_pair);
#line 115 "src/stdlib/net.yi"
    YisVal v_k = yis_net_encode_component(yis_net__pair_key(v_pair)); yis_retain_val(v_k);
#line 116 "src/stdlib/net.yi"
    YisVal v_v = yis_net_encode_component(yis_net__pair_val(v_pair)); yis_retain_val(v_v);
#line 117 "src/stdlib/net.yi"
    if (yis_as_bool(yis_gt(v_i, YV_INT(0)))) {
      (void)(stdr_push(v_parts, YV_STR(stdr_str_lit("&"))));
    }
#line 118 "src/stdlib/net.yi"
    (void)(stdr_push(v_parts, v_k));
#line 119 "src/stdlib/net.yi"
    (void)(stdr_push(v_parts, YV_STR(stdr_str_lit("="))));
#line 120 "src/stdlib/net.yi"
    (void)(stdr_push(v_parts, v_v));
  }
#line 121 "src/stdlib/net.yi"
  return yis_stdr_join(v_parts);
}

static YisVal yis_net_with_query(YisVal v_url, YisVal v_params) {
#line 125 "src/stdlib/net.yi"
  YisVal v_q = yis_net_build_query(v_params); yis_retain_val(v_q);
#line 126 "src/stdlib/net.yi"
  if (yis_as_bool(yis_eq(YV_INT(stdr_len(v_q)), YV_INT(0)))) {
    return v_url;
  }
#line 127 "src/stdlib/net.yi"
  if (yis_as_bool(yis_net__contains(v_url, YV_STR(stdr_str_lit("?"))))) {
#line 128 "src/stdlib/net.yi"
    return yis_stdr_str_concat(yis_stdr_str_concat(v_url, YV_STR(stdr_str_lit("&"))), v_q);
  }
#line 129 "src/stdlib/net.yi"
  return yis_stdr_str_concat(yis_stdr_str_concat(v_url, YV_STR(stdr_str_lit("?"))), v_q);
}

static YisVal yis_net__parse_status_payload(YisVal v_raw) {
#line 133 "src/stdlib/net.yi"
  YisVal v_marker = YV_STR(stdr_str_lit("__YIS_HTTP_STATUS__:")); yis_retain_val(v_marker);
#line 134 "src/stdlib/net.yi"
  YisVal v_end_marker = YV_STR(stdr_str_lit("__YIS_HTTP_END__")); yis_retain_val(v_end_marker);
#line 135 "src/stdlib/net.yi"
  YisVal v_idx = yis_net__last_index_of(v_raw, v_marker); yis_retain_val(v_idx);
#line 137 "src/stdlib/net.yi"
  YisVal v_result = yis_dict_lit(0); yis_retain_val(v_result);
#line 138 "src/stdlib/net.yi"
  (void)(yis_index_set(v_result, YV_STR(stdr_str_lit("status")), YV_INT(0)));
#line 139 "src/stdlib/net.yi"
  (void)(yis_index_set(v_result, YV_STR(stdr_str_lit("body")), v_raw));
#line 141 "src/stdlib/net.yi"
  if (yis_as_bool(yis_lt(v_idx, YV_INT(0)))) {
    return v_result;
  }
#line 143 "src/stdlib/net.yi"
  YisVal v_from = yis_add(v_idx, YV_INT(stdr_len(v_marker))); yis_retain_val(v_from);
#line 144 "src/stdlib/net.yi"
  YisVal v_end = yis_net__last_index_of(v_raw, v_end_marker); yis_retain_val(v_end);
#line 145 "src/stdlib/net.yi"
  if (yis_as_bool(yis_lt(v_end, v_from))) {
    return v_result;
  }
#line 147 "src/stdlib/net.yi"
  YisVal v_status_text = stdr_slice(v_raw, yis_as_int(v_from), yis_as_int(v_end)); yis_retain_val(v_status_text);
#line 148 "src/stdlib/net.yi"
  (void)(yis_index_set(v_result, YV_STR(stdr_str_lit("status")), yis_net__parse_int(v_status_text)));
#line 149 "src/stdlib/net.yi"
  (void)(yis_index_set(v_result, YV_STR(stdr_str_lit("body")), stdr_slice(v_raw, yis_as_int(YV_INT(0)), yis_as_int(v_idx))));
#line 150 "src/stdlib/net.yi"
  return v_result;
}

static YisVal yis_net_request(YisVal v_method, YisVal v_url, YisVal v_body, YisVal v_headers, YisVal v_params, YisVal v_timeout_secs, YisVal v_follow_redirects) {
#line 154 "src/stdlib/net.yi"
  YisVal v_request_url = yis_net_with_query(v_url, v_params); yis_retain_val(v_request_url);
#line 155 "src/stdlib/net.yi"
  YisVal v_cmd = YV_STR(stdr_str_lit("curl -sS")); yis_retain_val(v_cmd);
#line 157 "src/stdlib/net.yi"
  if (yis_as_bool(v_follow_redirects)) {
#line 158 "src/stdlib/net.yi"
    (void)((yis_move_into(&v_cmd, yis_stdr_str_concat(v_cmd, YV_STR(stdr_str_lit(" -L")))), v_cmd));
  }
#line 160 "src/stdlib/net.yi"
  if (yis_as_bool(yis_gt(v_timeout_secs, YV_INT(0)))) {
#line 161 "src/stdlib/net.yi"
    (void)((yis_move_into(&v_cmd, yis_stdr_str_concat(v_cmd, YV_STR(stdr_str_lit(" --max-time ")))), v_cmd));
#line 162 "src/stdlib/net.yi"
    (void)((yis_move_into(&v_cmd, yis_stdr_str_concat(v_cmd, YV_STR(stdr_to_string(v_timeout_secs)))), v_cmd));
  }
#line 164 "src/stdlib/net.yi"
  (void)((yis_move_into(&v_cmd, yis_stdr_str_concat(v_cmd, YV_STR(stdr_str_lit(" -X ")))), v_cmd));
#line 165 "src/stdlib/net.yi"
  (void)((yis_move_into(&v_cmd, yis_stdr_str_concat(v_cmd, yis_net__shell_quote(v_method))), v_cmd));
#line 167 "src/stdlib/net.yi"
  YisVal v_i = YV_INT(0); yis_retain_val(v_i);
#line 168 "src/stdlib/net.yi"
  YisVal v_hn = YV_INT(stdr_len(v_headers)); yis_retain_val(v_hn);
#line 169 "src/stdlib/net.yi"
  for (; yis_as_bool(yis_lt(v_i, v_hn)); (void)((yis_move_into(&v_i, yis_add(v_i, YV_INT(1))), v_i))) {
#line 170 "src/stdlib/net.yi"
    YisVal v_pair = yis_index(v_headers, v_i); yis_retain_val(v_pair);
#line 171 "src/stdlib/net.yi"
    YisVal v_hk = yis_net__pair_key(v_pair); yis_retain_val(v_hk);
#line 172 "src/stdlib/net.yi"
    YisVal v_hv = yis_net__pair_val(v_pair); yis_retain_val(v_hv);
#line 173 "src/stdlib/net.yi"
    if (yis_as_bool(yis_eq(YV_INT(stdr_len(v_hk)), YV_INT(0)))) {
      continue;
    }
#line 174 "src/stdlib/net.yi"
    YisVal v_hline = yis_stdr_str_concat(yis_stdr_str_concat(v_hk, YV_STR(stdr_str_lit(": "))), v_hv); yis_retain_val(v_hline);
#line 175 "src/stdlib/net.yi"
    (void)((yis_move_into(&v_cmd, yis_stdr_str_concat(v_cmd, YV_STR(stdr_str_lit(" -H ")))), v_cmd));
#line 176 "src/stdlib/net.yi"
    (void)((yis_move_into(&v_cmd, yis_stdr_str_concat(v_cmd, yis_net__shell_quote(v_hline))), v_cmd));
  }
#line 178 "src/stdlib/net.yi"
  if (yis_as_bool(YV_BOOL(!yis_as_bool(YV_BOOL(stdr_is_null(v_body)))))) {
#line 179 "src/stdlib/net.yi"
    (void)((yis_move_into(&v_cmd, yis_stdr_str_concat(v_cmd, YV_STR(stdr_str_lit(" --data-binary ")))), v_cmd));
#line 180 "src/stdlib/net.yi"
    (void)((yis_move_into(&v_cmd, yis_stdr_str_concat(v_cmd, yis_net__shell_quote(YV_STR(stdr_to_string(v_body))))), v_cmd));
  }
#line 182 "src/stdlib/net.yi"
  (void)((yis_move_into(&v_cmd, yis_stdr_str_concat(v_cmd, YV_STR(stdr_str_lit(" ")))), v_cmd));
#line 183 "src/stdlib/net.yi"
  (void)((yis_move_into(&v_cmd, yis_stdr_str_concat(v_cmd, yis_net__shell_quote(v_request_url))), v_cmd));
#line 184 "src/stdlib/net.yi"
  (void)((yis_move_into(&v_cmd, yis_stdr_str_concat(v_cmd, YV_STR(stdr_str_lit(" -w '__YIS_HTTP_STATUS__:%{http_code}__YIS_HTTP_END__'")))), v_cmd));
#line 185 "src/stdlib/net.yi"
  (void)((yis_move_into(&v_cmd, yis_stdr_str_concat(v_cmd, YV_STR(stdr_str_lit(" 2>&1")))), v_cmd));
#line 187 "src/stdlib/net.yi"
  YisVal v_run = yis_stdr_run_command(v_cmd); yis_retain_val(v_run);
#line 188 "src/stdlib/net.yi"
  YisVal v_curl_exit = YV_INT(stdr_num(((yis_index(v_run, YV_INT(0))).tag == EVT_NULL ? (YV_INT(1)) : (yis_index(v_run, YV_INT(0)))))); yis_retain_val(v_curl_exit);
#line 189 "src/stdlib/net.yi"
  YisVal v_raw = ((yis_index(v_run, YV_INT(1))).tag == EVT_NULL ? (YV_STR(stdr_str_lit(""))) : (yis_index(v_run, YV_INT(1)))); yis_retain_val(v_raw);
#line 190 "src/stdlib/net.yi"
  YisVal v_parsed = yis_net__parse_status_payload(v_raw); yis_retain_val(v_parsed);
#line 191 "src/stdlib/net.yi"
  YisVal v_status = YV_INT(stdr_num(((yis_index(v_parsed, YV_STR(stdr_str_lit("status")))).tag == EVT_NULL ? (YV_INT(0)) : (yis_index(v_parsed, YV_STR(stdr_str_lit("status"))))))); yis_retain_val(v_status);
#line 192 "src/stdlib/net.yi"
  YisVal v_text = YV_STR(stdr_to_string(((yis_index(v_parsed, YV_STR(stdr_str_lit("body")))).tag == EVT_NULL ? (YV_STR(stdr_str_lit(""))) : (yis_index(v_parsed, YV_STR(stdr_str_lit("body"))))))); yis_retain_val(v_text);
#line 194 "src/stdlib/net.yi"
  YisVal v_resp = yis_dict_lit(0); yis_retain_val(v_resp);
#line 195 "src/stdlib/net.yi"
  (void)(yis_index_set(v_resp, YV_STR(stdr_str_lit("method")), v_method));
#line 196 "src/stdlib/net.yi"
  (void)(yis_index_set(v_resp, YV_STR(stdr_str_lit("url")), v_url));
#line 197 "src/stdlib/net.yi"
  (void)(yis_index_set(v_resp, YV_STR(stdr_str_lit("request_url")), v_request_url));
#line 198 "src/stdlib/net.yi"
  (void)(yis_index_set(v_resp, YV_STR(stdr_str_lit("status")), v_status));
#line 199 "src/stdlib/net.yi"
  (void)(yis_index_set(v_resp, YV_STR(stdr_str_lit("body")), v_text));
#line 200 "src/stdlib/net.yi"
  (void)(yis_index_set(v_resp, YV_STR(stdr_str_lit("curl_exit")), v_curl_exit));
#line 201 "src/stdlib/net.yi"
  (void)(yis_index_set(v_resp, YV_STR(stdr_str_lit("ok")), YV_BOOL(yis_as_bool(YV_BOOL(yis_as_bool(yis_eq(v_curl_exit, YV_INT(0))) && yis_as_bool(yis_ge(v_status, YV_INT(200))))) && yis_as_bool(yis_lt(v_status, YV_INT(300))))));
#line 203 "src/stdlib/net.yi"
  if (yis_as_bool(yis_ne(v_curl_exit, YV_INT(0)))) {
#line 204 "src/stdlib/net.yi"
    (void)(yis_index_set(v_resp, YV_STR(stdr_str_lit("error")), v_text));
  } else {
#line 206 "src/stdlib/net.yi"
    (void)(yis_index_set(v_resp, YV_STR(stdr_str_lit("error")), YV_NULLV));
  }
#line 208 "src/stdlib/net.yi"
  return v_resp;
}

static YisVal yis_net_get(YisVal v_url, YisVal v_params, YisVal v_headers, YisVal v_timeout_secs) {
#line 212 "src/stdlib/net.yi"
  return yis_net_request(YV_STR(stdr_str_lit("GET")), v_url, YV_NULLV, v_headers, v_params, v_timeout_secs, YV_BOOL(true));
}

static YisVal yis_net_post(YisVal v_url, YisVal v_body, YisVal v_headers, YisVal v_params, YisVal v_timeout_secs) {
#line 216 "src/stdlib/net.yi"
  return yis_net_request(YV_STR(stdr_str_lit("POST")), v_url, v_body, v_headers, v_params, v_timeout_secs, YV_BOOL(true));
}

static YisVal yis_net_post_json(YisVal v_url, YisVal v_json_text, YisVal v_headers, YisVal v_params, YisVal v_timeout_secs) {
#line 220 "src/stdlib/net.yi"
  YisVal v_hs = v_headers; yis_retain_val(v_hs);
#line 221 "src/stdlib/net.yi"
  (void)(stdr_push(v_hs, yis_arr_lit(2, YV_STR(stdr_str_lit("Content-Type")), YV_STR(stdr_str_lit("application/json")))));
#line 222 "src/stdlib/net.yi"
  return yis_net_request(YV_STR(stdr_str_lit("POST")), v_url, v_json_text, v_hs, v_params, v_timeout_secs, YV_BOOL(true));
}

static YisVal __fnwrap_net__hex_digit(void* env, int argc, YisVal* argv) {
  (void)env; (void)argc;
  YisVal __a0 = argc > 0 ? argv[0] : YV_NULLV;
  return yis_net__hex_digit(__a0);
}

static YisVal __fnwrap_net__is_alpha_num(void* env, int argc, YisVal* argv) {
  (void)env; (void)argc;
  YisVal __a0 = argc > 0 ? argv[0] : YV_NULLV;
  return yis_net__is_alpha_num(__a0);
}

static YisVal __fnwrap_net__is_unreserved(void* env, int argc, YisVal* argv) {
  (void)env; (void)argc;
  YisVal __a0 = argc > 0 ? argv[0] : YV_NULLV;
  return yis_net__is_unreserved(__a0);
}

static YisVal __fnwrap_net__shell_quote(void* env, int argc, YisVal* argv) {
  (void)env; (void)argc;
  YisVal __a0 = argc > 0 ? argv[0] : YV_NULLV;
  return yis_net__shell_quote(__a0);
}

static YisVal __fnwrap_net__contains(void* env, int argc, YisVal* argv) {
  (void)env; (void)argc;
  YisVal __a0 = argc > 0 ? argv[0] : YV_NULLV;
  YisVal __a1 = argc > 1 ? argv[1] : YV_NULLV;
  return yis_net__contains(__a0, __a1);
}

static YisVal __fnwrap_net__last_index_of(void* env, int argc, YisVal* argv) {
  (void)env; (void)argc;
  YisVal __a0 = argc > 0 ? argv[0] : YV_NULLV;
  YisVal __a1 = argc > 1 ? argv[1] : YV_NULLV;
  return yis_net__last_index_of(__a0, __a1);
}

static YisVal __fnwrap_net__parse_int(void* env, int argc, YisVal* argv) {
  (void)env; (void)argc;
  YisVal __a0 = argc > 0 ? argv[0] : YV_NULLV;
  return yis_net__parse_int(__a0);
}

static YisVal __fnwrap_net__pair_key(void* env, int argc, YisVal* argv) {
  (void)env; (void)argc;
  YisVal __a0 = argc > 0 ? argv[0] : YV_NULLV;
  return yis_net__pair_key(__a0);
}

static YisVal __fnwrap_net__pair_val(void* env, int argc, YisVal* argv) {
  (void)env; (void)argc;
  YisVal __a0 = argc > 0 ? argv[0] : YV_NULLV;
  return yis_net__pair_val(__a0);
}

static YisVal __fnwrap_net_encode_component(void* env, int argc, YisVal* argv) {
  (void)env; (void)argc;
  YisVal __a0 = argc > 0 ? argv[0] : YV_NULLV;
  return yis_net_encode_component(__a0);
}

static YisVal __fnwrap_net_build_query(void* env, int argc, YisVal* argv) {
  (void)env; (void)argc;
  YisVal __a0 = argc > 0 ? argv[0] : YV_NULLV;
  return yis_net_build_query(__a0);
}

static YisVal __fnwrap_net_with_query(void* env, int argc, YisVal* argv) {
  (void)env; (void)argc;
  YisVal __a0 = argc > 0 ? argv[0] : YV_NULLV;
  YisVal __a1 = argc > 1 ? argv[1] : YV_NULLV;
  return yis_net_with_query(__a0, __a1);
}

static YisVal __fnwrap_net__parse_status_payload(void* env, int argc, YisVal* argv) {
  (void)env; (void)argc;
  YisVal __a0 = argc > 0 ? argv[0] : YV_NULLV;
  return yis_net__parse_status_payload(__a0);
}

static YisVal __fnwrap_net_request(void* env, int argc, YisVal* argv) {
  (void)env; (void)argc;
  YisVal __a0 = argc > 0 ? argv[0] : YV_NULLV;
  YisVal __a1 = argc > 1 ? argv[1] : YV_NULLV;
  YisVal __a2 = argc > 2 ? argv[2] : YV_NULLV;
  ...
  return yis_net_request(__a0, __a1, __a2, __a3, __a4, __a5, __a6);
}

static YisVal __fnwrap_net_get(void* env, int argc, YisVal* argv) {
  (void)env; (void)argc;
  YisVal __a0 = argc > 0 ? argv[0] : YV_NULLV;
  YisVal __a1 = argc > 1 ? argv[1] : YV_NULLV;
  YisVal __a2 = argc > 2 ? argv[2] : YV_NULLV;
  YisVal __a3 = argc > 3 ? argv[3] : YV_NULLV;
  return yis_net_get(__a0, __a1, __a2, __a3);
}

static YisVal __fnwrap_net_post(void* env, int argc, YisVal* argv) {
  (void)env; (void)argc;
  YisVal __a0 = argc > 0 ? argv[0] : YV_NULLV;
  YisVal __a1 = argc > 1 ? argv[1] : YV_NULLV;
  YisVal __a2 = argc > 2 ? argv[2] : YV_NULLV;
  YisVal __a3 = argc > 3 ? argv[3] : YV_NULLV;
  YisVal __a4 = argc > 4 ? argv[4] : YV_NULLV;
  return yis_net_post(__a0, __a1, __a2, __a3, __a4);
}

static YisVal __fnwrap_net_post_json(void* env, int argc, YisVal* argv) {
  (void)env; (void)argc;
  YisVal __a0 = argc > 0 ? argv[0] : YV_NULLV;
  YisVal __a1 = argc > 1 ? argv[1] : YV_NULLV;
  YisVal __a2 = argc > 2 ? argv[2] : YV_NULLV;
  YisVal __a3 = argc > 3 ? argv[3] : YV_NULLV;
  YisVal __a4 = argc > 4 ? argv[4] : YV_NULLV;
  return yis_net_post_json(__a0, __a1, __a2, __a3, __a4);
}

/* end embedded module: net */
...
// bring json
static void yis_entry(void) {
  YisVal v_url = YV_STR(stdr_str_lit("https://open.er-api.com/v6/latest/USD")); yis_retain_val(v_url);
  YisVal v_resp = yis_net_get(YV_STR(stdr_str_lit("https://open.er-api.com/v6/latest/USD")), yis_arr_lit(0), yis_arr_lit(1, yis_arr_lit(2, YV_STR(stdr_str_lit("Accept")), YV_STR(stdr_str_lit("application/json")))), YV_INT(20)); yis_retain_val(v_resp);
  if (yis_as_bool(YV_BOOL(!yis_as_bool(((yis_index(v_resp, YV_STR(stdr_str_lit("ok")))).tag == EVT_NULL ? (YV_BOOL(false)) : (yis_index(v_resp, YV_STR(stdr_str_lit("ok"))))))))) {
    YisVal v_status = ((yis_index(v_resp, YV_STR(stdr_str_lit("status")))).tag == EVT_NULL ? (YV_INT(0)) : (yis_index(v_resp, YV_STR(stdr_str_lit("status"))))); yis_retain_val(v_status);
    YisVal v_err_msg = ((yis_index(v_resp, YV_STR(stdr_str_lit("error")))).tag == EVT_NULL ? (YV_STR(stdr_str_lit("unknown"))) : (yis_index(v_resp, YV_STR(stdr_str_lit("error"))))); yis_retain_val(v_err_msg);
    (void)(stdr_write(({ YisVal __ip[5]; __ip[0] = YV_STR(stdr_str_lit("HTTP request failed. status=")); __ip[1] = YV_STR(stdr_to_string(v_status)); __ip[2] = YV_STR(stdr_str_lit(" error=")); __ip[3] = YV_STR(stdr_to_string(v_err_msg)); __ip[4] = YV_STR(stdr_str_lit("\n")); YV_STR(stdr_str_from_parts(5, __ip)); })));
    return;
  }
  YisVal v_body = YV_STR(stdr_to_string(((yis_index(v_resp, YV_STR(stdr_str_lit("body")))).tag == EVT_NULL ? (YV_STR(stdr_str_lit(""))) : (yis_index(v_resp, YV_STR(stdr_str_lit("body"))))))); yis_retain_val(v_body);
  YisVal v_root = yis_json_parse(v_body); yis_retain_val(v_root);
  YisVal v_rates = yis_json_get(v_root, YV_STR(stdr_str_lit("rates")), YV_NULLV); yis_retain_val(v_rates);
  YisVal v_brl = yis_json_get(v_rates, YV_STR(stdr_str_lit("BRL")), YV_NULLV); yis_retain_val(v_brl);
  if (yis_as_bool(YV_BOOL(stdr_is_null(v_brl)))) {
    (void)(stdr_write(YV_STR(stdr_str_lit("Could not extract BRL rate from response.\n"))));
    return;
  }
  (void)(stdr_write(({ YisVal __ip[3]; __ip[0] = YV_STR(stdr_str_lit("1 USD = ")); __ip[1] = YV_STR(stdr_to_string(v_brl)); __ip[2] = YV_STR(stdr_str_lit(" BRL\n")); YV_STR(stdr_str_from_parts(3, __ip)); })));
}
