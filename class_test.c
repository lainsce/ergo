...
/* begin main unit */
typedef struct YisObj_class_test_Point {
    YisObj base;
    YisVal f_x;
    YisVal f_y;
} YisObj_class_test_Point;
static void yis_drop_class_test_Point(YisObj* o);
static void yis_drop_class_test_Point(YisObj* o) {
    YisObj_class_test_Point* self = (YisObj_class_test_Point*)o;
    yis_release_val(self->f_x);
    yis_release_val(self->f_y);
}
static void yis_entry(void);
static YisVal yis_m_class_test_Point_to_string(YisVal);
static YisVal yis_m_class_test_Point_add(YisVal, YisVal);

// cask class_test
// bring stdr
static YisVal yis_m_class_test_Point_to_string(YisVal v_this) {
  YisVal v_s = YV_STR(stdr_str_lit("Point(")); yis_retain_val(v_s);
  (void)((yis_move_into(&v_s, yis_stdr_str_concat(v_s, YV_STR(stdr_to_string(({
    YisVal _mfr = ((YisObj_class_test_Point*)(v_this).as.p)->f_x;
    yis_retain_val(_mfr);
    _mfr;
}))))), v_s));
  (void)((yis_move_into(&v_s, yis_stdr_str_concat(v_s, YV_STR(stdr_str_lit(", ")))), v_s));
  (void)((yis_move_into(&v_s, yis_stdr_str_concat(v_s, YV_STR(stdr_to_string(({
    YisVal _mfr = ((YisObj_class_test_Point*)(v_this).as.p)->f_y;
    yis_retain_val(_mfr);
    _mfr;
}))))), v_s));
  (void)((yis_move_into(&v_s, yis_stdr_str_concat(v_s, YV_STR(stdr_str_lit(")")))), v_s));
...
static YisVal yis_m_class_test_Point_add(YisVal v_this, YisVal v_other) {
  return ({
    YisObj_class_test_Point* _obj1 = (YisObj_class_test_Point*)yis_obj_new(sizeof(YisObj_class_test_Point), yis_drop_class_test_Point);
    _obj1->f_x = YV_NULLV;
    _obj1->f_y = YV_NULLV;
    ...
    YisVal _mfr = ((YisObj_class_test_Point*)(v_other).as.p)->f_x;
    yis_retain_val(_mfr);
    _mfr;
})));
    ...
    YisVal _mfr = ((YisObj_class_test_Point*)(v_other).as.p)->f_y;
    yis_retain_val(_mfr);
    _mfr;
})));
...
static void yis_entry(void) {
#line 24 "/Users/nayu/Developer/Yis/examples/class_test.yi"
  YisVal v_p1 = ({
    YisObj_class_test_Point* _obj2 = (YisObj_class_test_Point*)yis_obj_new(sizeof(YisObj_class_test_Point), yis_drop_class_test_Point);
    _obj2->f_x = YV_NULLV;
    _obj2->f_y = YV_NULLV;
    yis_move_into(&_obj2->f_x, YV_INT(3));
    yis_move_into(&_obj2->f_y, YV_INT(4));
    YisVal _obj2_v = YV_OBJ((YisObj*)_obj2);
    _obj2_v;
}); yis_retain_val(v_p1);
#line 25 "/Users/nayu/Developer/Yis/examples/class_test.yi"
  (void)(stdr_write(yis_m_class_test_Point_to_string(v_p1)));
#line 26 "/Users/nayu/Developer/Yis/examples/class_test.yi"
  (void)(stdr_write(YV_STR(stdr_str_lit("\n"))));
#line 28 "/Users/nayu/Developer/Yis/examples/class_test.yi"
  YisVal v_p2 = ({
    YisObj_class_test_Point* _obj3 = (YisObj_class_test_Point*)yis_obj_new(sizeof(YisObj_class_test_Point), yis_drop_class_test_Point);
    _obj3->f_x = YV_NULLV;
    _obj3->f_y = YV_NULLV;
    yis_move_into(&_obj3->f_x, YV_INT(10));
    yis_move_into(&_obj3->f_y, YV_INT(20));
    YisVal _obj3_v = YV_OBJ((YisObj*)_obj3);
    _obj3_v;
}); yis_retain_val(v_p2);
#line 29 "/Users/nayu/Developer/Yis/examples/class_test.yi"
  (void)(stdr_write(yis_m_class_test_Point_to_string(v_p2)));
#line 30 "/Users/nayu/Developer/Yis/examples/class_test.yi"
  (void)(stdr_write(YV_STR(stdr_str_lit("\n"))));
#line 32 "/Users/nayu/Developer/Yis/examples/class_test.yi"
  YisVal v_p3 = yis_m_class_test_Point_add(v_p1, v_p2); yis_retain_val(v_p3);
#line 33 "/Users/nayu/Developer/Yis/examples/class_test.yi"
  (void)(stdr_write(yis_m_class_test_Point_to_string(v_p3)));
#line 34 "/Users/nayu/Developer/Yis/examples/class_test.yi"
  (void)(stdr_write(YV_STR(stdr_str_lit("\n"))));
#line 37 "/Users/nayu/Developer/Yis/examples/class_test.yi"
  YisVal v_p4 = ({
    YisObj_class_test_Point* _obj4 = (YisObj_class_test_Point*)yis_obj_new(sizeof(YisObj_class_test_Point), yis_drop_class_test_Point);
    _obj4->f_x = YV_NULLV;
    _obj4->f_y = YV_NULLV;
    yis_move_into(&_obj4->f_x, YV_INT(0));
    yis_move_into(&_obj4->f_y, YV_INT(0));
    YisVal _obj4_v = YV_OBJ((YisObj*)_obj4);
    _obj4_v;
}); yis_retain_val(v_p4);
#line 38 "/Users/nayu/Developer/Yis/examples/class_test.yi"
  (void)(yis_move_into(&((YisObj_class_test_Point*)(v_p4).as.p)->f_x, YV_INT(42)));
#line 39 "/Users/nayu/Developer/Yis/examples/class_test.yi"
  (void)(yis_move_into(&((YisObj_class_test_Point*)(v_p4).as.p)->f_y, YV_INT(99)));
#line 40 "/Users/nayu/Developer/Yis/examples/class_test.yi"
  (void)(stdr_write(yis_m_class_test_Point_to_string(v_p4)));
#line 41 "/Users/nayu/Developer/Yis/examples/class_test.yi"
  (void)(stdr_write(YV_STR(stdr_str_lit("\n"))));
}
