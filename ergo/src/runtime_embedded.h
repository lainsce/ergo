...
"#endif\n"
"\n"
"// Cogito GUI headers for bindings\n"
"#include \"../../cogito/src/cogito.h\"\n"
"\n"
"#if defined(_WIN32)\n"
"#include <windows.h>\n"
"#include <io.h>\n"
...
"  ErgoStr* icon = (iconv.tag == EVT_STR) ? (ErgoStr*)iconv.as.p : NULL;\n"
...
"  cogito_node* n = cogito_node_from_val(nodev);\n"
"  if (!n || n->menu_len == 0) return;\n"
"  ErgoStr* shortcut = (shortcutv.tag == EVT_STR) ? (ErgoStr*)shortcutv.as.p : NULL;\n"
"  cogito_node_menu_set_shortcut(n, shortcut);\n"
"}\n"
"\n"
"static void __cogito_menu_set_submenu(ErgoVal nodev, ErgoVal submenuv) {\n"
"  cogito_node* n = cogito_node_from_val(nodev);\n"
"  if (!n || n->menu_len == 0) return;\n"
"  cogito_node_menu_set_submenu(n, ergo_as_bool(submenuv));\n"
"}\n"
"\n"
"static void __cogito_menu_set_toggled(ErgoVal nodev, ErgoVal toggledv) {\n"
"  cogito_node* n = cogito_node_from_val(nodev);\n"
"  if (!n || n->menu_len == 0) return;\n"
"  cogito_node_menu_set_toggled(n, ergo_as_bool(toggledv));\n"
"}\n"
"\n"
