...
/* begin main unit */
typedef struct YisObj_new_syntax_test_Vec2 {
    YisObj base;
    YisVal f_x;
    YisVal f_y;
} YisObj_new_syntax_test_Vec2;
static void yis_drop_new_syntax_test_Vec2(YisObj* o);
static void yis_drop_new_syntax_test_Vec2(YisObj* o) {
    YisObj_new_syntax_test_Vec2* self = (YisObj_new_syntax_test_Vec2*)o;
    yis_release_val(self->f_x);
    yis_release_val(self->f_y);
}
static void yis_new_syntax_test_greet(YisVal);
static void yis_entry(void);
static YisVal yis_m_new_syntax_test_Vec2_add(YisVal, YisVal);
static void yis_m_new_syntax_test_Vec2_show(YisVal);
static YisVal __fnwrap_new_syntax_test_greet(void*,int,YisVal*);

// cask new_syntax_test
// bring stdr
static YisVal yis_m_new_syntax_test_Vec2_add(YisVal v_this, YisVal v_other) {
  return ({
    YisObj_new_syntax_test_Vec2* _obj1 = (YisObj_new_syntax_test_Vec2*)yis_obj_new(sizeof(YisObj_new_syntax_test_Vec2), yis_drop_new_syntax_test_Vec2);
    _obj1->f_x = YV_NULLV;
    _obj1->f_y = YV_NULLV;
    yis_move_into(&_obj1->f_x, yis_add(({
    YisVal _mfr = ((YisObj_new_syntax_test_Vec2*)(v_this).as.p)->f_x;
    yis_retain_val(_mfr);
    _mfr;
}), ({
    YisVal _mfr = ((YisObj_new_syntax_test_Vec2*)(v_other).as.p)->f_x;
    yis_retain_val(_mfr);
    _mfr;
})));
    yis_move_into(&_obj1->f_y, yis_add(({
    YisVal _mfr = ((YisObj_new_syntax_test_Vec2*)(v_this).as.p)->f_y;
    yis_retain_val(_mfr);
    _mfr;
}), ({
    YisVal _mfr = ((YisObj_new_syntax_test_Vec2*)(v_other).as.p)->f_y;
    yis_retain_val(_mfr);
    _mfr;
})));
    YisVal _obj1_v = YV_OBJ((YisObj*)_obj1);
    _obj1_v;
});
}

static void yis_m_new_syntax_test_Vec2_show(YisVal v_this) {
  (void)(stdr_write(({ YisVal __ip[5]; __ip[0] = YV_STR(stdr_str_lit("Vec2(")); __ip[1] = YV_STR(stdr_to_string(yis_get_field(((YisObj*)(v_this).as.p), stdr_str_lit("x")))); __ip[2] = YV_STR(stdr_str_lit(", ")); __ip[3] = YV_STR(stdr_to_string(yis_get_field(((YisObj*)(v_this).as.p), stdr_str_lit("y")))); __ip[4] = YV_STR(stdr_str_lit(")\n")); YV_STR(stdr_str_from_parts(5, __ip)); })));
}

static void yis_new_syntax_test_greet(YisVal v_name) {
  if (yis_as_bool(yis_eq(v_name, YV_STR(stdr_str_lit("World"))))) {
    (void)(stdr_write(YV_STR(stdr_str_lit("Hello, World!\n"))));
  } else if (yis_as_bool(yis_eq(v_name, YV_STR(stdr_str_lit("Yis"))))) {
    (void)(stdr_write(YV_STR(stdr_str_lit("Hello, Yis!\n"))));
  } else {
    (void)(stdr_write(({ YisVal __ip[3]; __ip[0] = YV_STR(stdr_str_lit("Hi, ")); __ip[1] = YV_STR(stdr_to_string(v_name)); __ip[2] = YV_STR(stdr_str_lit("!\n")); YV_STR(stdr_str_from_parts(3, __ip)); })));
  }

}

static void yis_entry(void) {
#line 27 "/Users/nayu/Developer/Yis/examples/new_syntax_test.yi"
  YisVal v_a = ({
    YisObj_new_syntax_test_Vec2* _obj2 = (YisObj_new_syntax_test_Vec2*)yis_obj_new(sizeof(YisObj_new_syntax_test_Vec2), yis_drop_new_syntax_test_Vec2);
    _obj2->f_x = YV_NULLV;
    _obj2->f_y = YV_NULLV;
    yis_move_into(&_obj2->f_x, YV_INT(1));
    yis_move_into(&_obj2->f_y, YV_INT(2));
    YisVal _obj2_v = YV_OBJ((YisObj*)_obj2);
    _obj2_v;
}); yis_retain_val(v_a);
#line 28 "/Users/nayu/Developer/Yis/examples/new_syntax_test.yi"
  YisVal v_b = ({
    YisObj_new_syntax_test_Vec2* _obj3 = (YisObj_new_syntax_test_Vec2*)yis_obj_new(sizeof(YisObj_new_syntax_test_Vec2), yis_drop_new_syntax_test_Vec2);
    _obj3->f_x = YV_NULLV;
    _obj3->f_y = YV_NULLV;
    yis_move_into(&_obj3->f_x, YV_INT(3));
    yis_move_into(&_obj3->f_y, YV_INT(4));
    YisVal _obj3_v = YV_OBJ((YisObj*)_obj3);
    _obj3_v;
}); yis_retain_val(v_b);
#line 29 "/Users/nayu/Developer/Yis/examples/new_syntax_test.yi"
  YisVal v_c = yis_m_new_syntax_test_Vec2_add(v_a, v_b); yis_retain_val(v_c);
#line 30 "/Users/nayu/Developer/Yis/examples/new_syntax_test.yi"
  (void)(yis_new_syntax_test_greet(YV_STR(stdr_str_lit("World"))));
#line 31 "/Users/nayu/Developer/Yis/examples/new_syntax_test.yi"
  (void)(yis_new_syntax_test_greet(YV_STR(stdr_str_lit("Yis"))));
#line 32 "/Users/nayu/Developer/Yis/examples/new_syntax_test.yi"
  (void)(yis_new_syntax_test_greet(YV_STR(stdr_str_lit("Friend"))));
#line 33 "/Users/nayu/Developer/Yis/examples/new_syntax_test.yi"
  (void)(yis_m_new_syntax_test_Vec2_show(v_c));
#line 34 "/Users/nayu/Developer/Yis/examples/new_syntax_test.yi"
  { YisVal v_i = YV_INT(0); yis_retain_val(v_i);
  for (; yis_as_bool(yis_lt(v_i, YV_INT(3))); (void)((yis_move_into(&v_i, yis_add(v_i, YV_INT(1))), v_i))) {
#line 35 "/Users/nayu/Developer/Yis/examples/new_syntax_test.yi"
    (void)(stdr_write(({ YisVal __ip[3]; __ip[0] = YV_STR(stdr_str_lit("i = ")); __ip[1] = YV_STR(stdr_to_string(v_i)); __ip[2] = YV_STR(stdr_str_lit("\n")); YV_STR(stdr_str_from_parts(3, __ip)); })));
  } }
}

static YisVal __fnwrap_new_syntax_test_greet(void* env, int argc, YisVal* argv) {
  (void)env; (void)argc;
  YisVal __a0 = argc > 0 ? argv[0] : YV_NULLV;
  yis_new_syntax_test_greet(__a0);
  return YV_NULLV;
}
